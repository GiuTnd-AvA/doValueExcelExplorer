...
from mcode_extraction.extraction.powershell_runner import ExecPsCode as ps
from core.excel_analyzer import ExcelAnalyzer as ea
from exporters.report_exporter import ReportExporter as re
...
ea_obj = ea(EXCEL_ROOT_PATH, EXPORT_MCODE_PATH)
...
excel_files_list = ea_obj.split_excel_root_path()
aggregated_info = ea_obj.get_aggregated_info()
...
txt_only_info = ea_obj.get_txt_only_connection_info()
